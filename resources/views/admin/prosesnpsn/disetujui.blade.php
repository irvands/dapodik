...
@section('header')
Permintaan NPSN(Disetujui)
@endsection

@section('breadcrumb')
<div class="section-header-breadcrumb">
    <div class="breadcrumb-item"><a href="{{route('home')}}">Dashboard</a></div>
    <div class="breadcrumb-item">Permintaan NPSN(Disetujui)</a></div>
</div>
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4>Data Permintaan NPSN(Disetujui)</h4>
                    ...
                    <table class="table table-bordered table-md">
                        <tbody>
                            ...
                            <tr>
                                ...
                                @elseif($data->sekolah->status == 'Ditolak')
