...
@section('header')
Permintaan NPSN(Pending)
@endsection

@section('breadcrumb')
<div class="section-header-breadcrumb">
    <div class="breadcrumb-item"><a href="{{route('home')}}">Dashboard</a></div>
    <div class="breadcrumb-item">Permintaan NPSN(Pending)</a></div>
</div>
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4>Data Permintaan NPSN(Pending)</h4>
                    ...
                    <table class="table table-bordered table-md">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-sm btn-info" id="viewprosesnpsn" href="#modalprosesnpsn"
                                        data-toggle="modal" data-target="#modalprosesnpsn" style="text-decoration:none;"
                                        data-nama="{{$data->nama_sekolah}}" data-alamat="{{$data->alamat}}"
                                        data-id="{{$data->id}}" data-status="{{$data->status}}"
                                        data-npsn="{{$data->npsn}}" data-sp="{{$data->surat_permohonan}}"
                                        data-si="{{$data->surat_ijin_pendirian}}"
                                        data-sklm="{{$data->sk_luas_tanah_milik}}"
                                        data-sklb="{{$data->sk_luas_bukan_milik}}" data-fpapan="{{$data->foto_papan}}"
                                        data-fsek="{{$data->foto_sekolah}}" data-koordinat="{{$data->koordinat}}"
                                        data-keterangan="{{$data->keterangan}}">Lihat Detail</button></td>
                                <td>
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th>:</th>
                            <td><a id="sklblink" href="" target="_blank">Surat Keterangan Luas Tanah Bukan Milik</a>
                            </td>
                        </tr>
                        <tr>
...
<div class="modal fade" id="modalketerangan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('tolaknpsn')}}" method="POST">
                    @csrf
