...
@section('header')
Permintaan Perubahan Nomenklatur(Disetujui)
@endsection

@section('breadcrumb')
<div class="section-header-breadcrumb">
    <div class="breadcrumb-item"><a href="{{route('home')}}">Dashboard</a></div>
    <div class="breadcrumb-item">Permintaan Permintaan Perubahan Nomenklatur(Disetujui)</a></div>
</div>
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4>Permintaan Perubahan Nomenklatur(Disetujui)</h4>
