...
@section('header')
Permintaan Perubahan Nomenklatur(Diteruskan)
@endsection

@section('breadcrumb')
<div class="section-header-breadcrumb">
    <div class="breadcrumb-item"><a href="{{route('home')}}">Dashboard</a></div>
    <div class="breadcrumb-item">Permintaan Perubahan Nomenklatur(Diteruskan)</a></div>
</div>
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4>Data Perubahan Nomenklatur(Diteruskan)</h4>
