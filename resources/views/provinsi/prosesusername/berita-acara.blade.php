...
<head>
    <title>Berita Acara Pengajuan Username Dapodik</title>
    <style type="text/css">
        table {
            border-style: double;
            border-width: 3px;
    ...
    <table class="tb-center">
        ...
        <tr>
            <td class="judul-surat" colspan="3"><b>BERITA ACARA </b>
                <br><b>VERIFIKASI DAN IDENTIFIKASI BERKAS PENGAJUAN USERNAME DAPODIK</br>
            </td>
    ...
    <table>
        <tr>
            <td class="kiri-kanan" colspan="3">
                <font size="2">&nbsp; &nbsp; Pada Hari <b>{{Carbon\Carbon::parse($username->created_at)
        ->translatedFormat('l, d F Y')}}</b> telah dilakukan proses verifikasi dan identifikasi berkas pengajuan Username Dapodik
        ...
        <tr class="text2">
            ...
            <td width="400"> : <b>{{$username->sekolah->npsn}}</b></td>
        </tr>
        <tr class="text2">
            <td width="180">Nama Sekolah</td>
            <td width="400"> : <b>{{$username->sekolah->nama_sekolah}}</b></td>
        </tr>
        <tr>
            <td width="180">Alamat</td>
            <td width="400"> : {{$username->sekolah->alamat}}</td>
        </tr>
        </table>
        ...
        <tr>
            <td class="kiri-kanan" colspan="3">
                ...
                dasar persetujuan pengajuan Username Baru.
                </font>
            </td>
            <td></td>
            <td></td>
        ...
        <tr>
            ...
            <td class="ttdpemohon">
            <b>Surabaya, {{Carbon\Carbon::parse($username->created_at)
