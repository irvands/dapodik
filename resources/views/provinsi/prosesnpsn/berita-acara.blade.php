...
<head>
    <title>Berita Acara Pengajuan NPSN Baru</title>
    <style type="text/css">
        table {
            border-style: double;
            border-width: 3px;
    ...
    <table class="tb-center">
        ...
        <tr>
            <td class="judul-surat" colspan="3"><b>BERITA ACARA </b>
                <br><b>VERIFIKASI DAN IDENTIFIKASI BERKAS PENGAJUAN NPSN BARU</br>
            </td>
    ...
    <table>
        <tr>
            <td class="kiri-kanan" colspan="3">
                <font size="2">&nbsp; &nbsp; Pada Hari <b>{{Carbon\Carbon::parse($npsn->created_at)
        ->translatedFormat('l, d F Y')}}</b> telah dilakukan proses verifikasi dan identifikasi berkas pengajuan NPSN Baru
        ...
        <tr class="text2">
            ...
            <td width="400"> : <b>{{$npsn->sekolah->nama_sekolah}}</b></td>
        </tr>
        <tr>
            <td width="180">Alamat</td>
            <td width="400"> : {{$npsn->sekolah->alamat}}</td>
        </tr>
        </table>
        ...
        <tr>
            <td class="kiri-kanan" colspan="3">
                ...
                dasar persetujuan pengajuan NPSN Baru.
                </font>
            </td>
            <td></td>
            <td></td>
        ...
        <tr>
            ...
            <td class="ttdpemohon">
            <b>Surabaya, {{Carbon\Carbon::parse($npsn->created_at)
