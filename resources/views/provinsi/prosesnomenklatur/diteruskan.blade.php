...
@section('header')
Permintaan Perubahan Nomenklatur
@endsection

@section('breadcrumb')
<div class="section-header-breadcrumb">
    <div class="breadcrumb-item"><a href="{{route('home')}}">Dashboard</a></div>
    <div class="breadcrumb-item">Permintaan Perubahan Nomenklatur</a></div>
</div>
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4>Data Perubahan Nomenklatur</h4>
                    ...
                    <table class="table table-bordered table-md">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="nomenklatur/berita-acara/download/{{$data->id}}" class="btn btn-info btn-block"><i class="fas fa-download"></i> Download</a>
                                </td>
                                <td>
                                <a href="nomenklatur/proses/setujui/{{$data->id}}" class="btn btn-success btn-block"><i class="fas fa-check-double"></i> Setujui</a>
                                </td> 
                            </tr>
                            @endforeach
                            @else
