...
@section('header')
Permintaan Username Dapodik(Disetujui)
@endsection

@section('breadcrumb')
<div class="section-header-breadcrumb">
    <div class="breadcrumb-item"><a href="{{route('home')}}">Dashboard</a></div>
    <div class="breadcrumb-item">Permintaan Username Dapodik(Disetujui)</a></div>
</div>
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4>Data Permintaan Username Dapodik(Disetujui)</h4>
                    ...
                    <table class="table table-bordered table-md">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$data->sekolah->username}}</td>
                                <td>{{$data->sekolah->password}}</td>

                              
                                <td> <button id="viewprosesusername" class="btn btn-sm btn-info" href="#modalviewprosesusername" data-toggle="modal" style="text-decoration:none;"
                                        data-target="#modalviewprosesusername"
                                        data-npsn="{{$data->sekolah->npsn}}"
                                        data-nama="{{$data->sekolah->nama_sekolah}}" data-alamat="{{$data->sekolah->alamat}}"
                                        data-status="{{$data->sekolah->status}}" data-spu="{{$data->sekolah->surat_permohonan_username}}"
                                        data-sto="{{$data->sekolah->surat_tugas_operator}}" data-keterangan="{{$data->sekolah->keterangan}}"
                                        >Lihat Data</button>
                                </td>
                            </tr>
                            @endforeach
